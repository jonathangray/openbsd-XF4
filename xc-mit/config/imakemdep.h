...
#ifdef hp9000
#ifdef hp300
#define imake_ccflags "-Dhp9000 -Dhp300"
#else
#define imake_ccflags "-Dhp9000"
#endif
#endif
...
#endif
#if (defined(hp9000) || defined(luna68k) || defined(__OpenBSD__)) && !defined(DEFAULT_CPP)
...
#endif
#if 1 /*defined(hp9000) || defined(luna68k) */
	"-traditional",
#endif
};
