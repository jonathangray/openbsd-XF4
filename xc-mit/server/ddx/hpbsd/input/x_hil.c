/* $Header: /tmp/OpenBSD-XF4-repo/xc-mit/server/ddx/hpbsd/input/Attic/x_hil.c,v 1.1.1.1 2001/10/24 13:13:22 todd Exp $ */
...
#if !defined(hp9000) && !defined(__m68k__)
#ifndef __apollo
#include "termio.h"
#else
...
#if defined(__hpux) || defined(__hp_osf) || defined(hp9000) || defined(__m68k__)
struct	 _LedCmd {
    int 	on;
    int		off;
