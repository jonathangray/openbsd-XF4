/* $Header: /tmp/OpenBSD-XF4-repo/xc-mit/server/ddx/hpbsd/input/Attic/x_hilinit.c,v 1.1.1.1 2001/10/24 13:13:22 todd Exp $ */
/*******************************************************************
**
**    *********************************************************
**    *
...
#define SHORT_STRLEN 4
	...
	case DEVICE_INIT: 
		...
		if (pHPDev->hpflags & IS_SERIAL_DEVICE)
			...
			&& pHPDev==hpKeyboard)
			FatalError ("Can't find a keymap in the "/**/DEF_DIRECTORY/**/"XHPKeymaps file for the X keyboard device.\n");
		    }
		else
