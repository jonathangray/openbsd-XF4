#ifndef XHPLIB_H
#define XHPLIB_H
/* $Header: /tmp/OpenBSD-XF4-repo/xc-mit/server/ddx/hpbsd/input/X11/Attic/XHPlib.h,v 1.1.1.1 2001/10/24 13:13:22 todd Exp $ */
...
typedef struct 
    {
#if defined(__hp9000s300) || defined(__apollo)	|| defined(hp300) || defined(__OpenBSD__) /* 68k aligns to 16 bits */
    XMotionEvent	ev;		
    char		pad;	
