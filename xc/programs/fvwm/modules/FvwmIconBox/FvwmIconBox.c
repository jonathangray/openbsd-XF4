...
#if 0
  /*
   * grand@isgtec.com says that X operation cannot be done in a signal handler.
   * However, this function may be called in a normal manner...
   * Anyway, to avoid calling X function, here is in '#if 0'
   */
