...
*/
/*
** $Header: /tmp/OpenBSD-XF4-repo/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/internals/monoTriangulationBackend.cc,v 1.1.1.1 2001/04/05 22:04:55 matthieu Exp $
*/
