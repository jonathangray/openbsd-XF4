...
*/
/*
** $Header: /tmp/OpenBSD-XF4-repo/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/internals/monoTriangulationBackend.cc,v 1.3 2004/02/13 22:40:57 matthieu Exp $
*/
