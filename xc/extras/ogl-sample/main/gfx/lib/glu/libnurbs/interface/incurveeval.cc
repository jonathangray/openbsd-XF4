...
**
** $Date: 2004/11/02 23:27:03 $ $Revision: 1.4 $
*/
/* $XFree86$ */

/*
** $Header: /tmp/OpenBSD-XF4-repo/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/interface/incurveeval.cc,v 1.4 2004/11/02 23:27:03 matthieu Exp $
*/
